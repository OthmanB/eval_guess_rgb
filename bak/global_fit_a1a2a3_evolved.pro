...
Nl0=length_param[2] ; Nl0
Nl1=length_param[3] ; Nl1
Nl2=length_param[4] ; Nl2
Nl3=length_param[5] ; Nl3
k=length_param[6] ; nombre de degrees pour le splitting
l=length_param[7] ; nombre de degrees pour la largeur
m=length_param[8] ; nombre de degrees pour le bruit
orb=length_param[9] ; ; nombre de degrees pour le bruit orbital ou d'hyper_param
...
f_l0= param2[Nmax+vis+2:Nmax+vis+2+Nl0-1]
if Nl1 gt 0 then f_l1= param2[Nmax+vis+2+Nl0:Nmax+vis+2+Nl0+Nl1-1]
if Nl2 gt 0 then f_l2= param2[Nmax+vis+2+Nl0+Nl1:Nmax+vis+2+Nl0+Nl1+Nl2-1]
if Nl3 gt 0 then f_l3= param2[Nmax+vis+2+Nl0+Nl1+Nl2:Nmax+vis+2+Nl0+Nl1+Nl2+Nl3-1]
for n=0., Nl0-1 do begin
	Amp_l0=abs(param2[n])
	gamma_l0=abs(param2[Nmax+j+k+vis+n]) 
	...
	model_final=model_l0+model_final
endfor
for n=0., Nl1-1 do begin
...
for n=0., Nl2-1 do begin
	f_l2_base[n]= param2[Nmax+vis+2+Nl0+Nl1+n]
endfor
for n=0., Nl3-1 do begin
	f_l3_base[n]=param2[Nmax+vis+2+Nl0+Nl1+Nl2+n]
endfor
